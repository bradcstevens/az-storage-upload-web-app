---
applyTo: "**/reflection-intermediate.instructions.md"
---
...
graph TD
    ...
    AnalyzePlan["3. Analyze Planning Phase Effectiveness<br>Was planning-comprehensive.instructions.md guidance effective? Was the plan accurate? Scope creep?"] -->
...
## 📝 Structure for `memory-bank/reflection-[feature_id].md`
  ...
  * **2. Planning Phase Review:**
      * How effective was the guidance from `Level3/planning-comprehensive.instructions.md`?
