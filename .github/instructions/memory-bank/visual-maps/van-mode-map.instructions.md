...
graph TD
    ...
    %% Rule Loading
    CheckMB_Van --> LoadVan["Load Rule:<br>.github/instructions/memory-bank/visual-maps/van_mode_split/van-mode-map"]
    CheckMB_Plan --> LoadPlan["Load Rule:<br>.github/instructions/memory-bank/visual-maps/plan-mode-map"]
    CheckMB_Creative --> LoadCreative["Load Rule:<br>.github/instructions/memory-bank/visual-maps/creative-mode-map"]
    CheckMB_Impl --> LoadImpl["Load Rule:<br>.github/instructions/memory-bank/visual-maps/implement-mode-map"]
    CheckMB_QA --> LoadQA["Load Rule:<br>.github/instructions/memory-bank/visual-maps/qa-mode-map"]
