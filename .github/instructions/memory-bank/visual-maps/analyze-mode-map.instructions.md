...
graph TD
    ...
    Bug -->|"Yes"| LoadBugTemplate["read_file({<br>target_file: '.github/instructions/memory-bank/Phases/AnalyzePhase/analyze-template-bugs.instructions.md',<br>should_read_entire_file: true<br>})"]
    
    Req -->|"Yes"| LoadReqTemplate["read_file({<br>target_file: '.github/instructions/memory-bank/Phases/AnalyzePhase/analyze-template-requirements.instructions.md',<br>should_read_entire_file: true<br>})"]
    
    Research -->|"Yes"| LoadResearchTemplate["read_file({<br>target_file: '.github/instructions/memory-bank/Phases/AnalyzePhase/analyze-template-research.instructions.md',<br>should_read_entire_file: true<br>})"]
    
    Brainstorm -->|"Yes"| LoadBrainstormTemplate["read_file({<br>target_file: '.github/instructions/memory-bank/Phases/AnalyzePhase/analyze-template-brainstorming.instructions.md',<br>should_read_entire_file: true<br>})"]
