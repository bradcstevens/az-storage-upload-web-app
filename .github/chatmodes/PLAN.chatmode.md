...
```mermaid
graph TD
    Start["START PLANNING"] --> ReadTasks["Read memory-bank/tasks.md"]
    ...
    CheckLevel -->|"Level 2"| Level2["LEVEL 2 PLANNING<br>Level2/workflow-level2.instructions.md"]
    CheckLevel -->|"Level 3"| Level3["LEVEL 3 PLANNING<br>Level3/planning-comprehensive.instructions.md"]
    CheckLevel -->|"Level 4"| Level4["LEVEL 4 PLANNING<br>Level4/architectural-planning.instructions.md"]
