...
graph TD
    ...
    CheckLevel -->|"Level 1<br>Quick Bug Fix"| L1Process["🔧 LEVEL 1 PROCESS<br>.github/instructions/memory-bank/visual-maps/implement-mode-map.md"]
    ...
    CheckLevel -->|"Level 2<br>Simple Enhancement"| L2Process["🔨 LEVEL 2 PROCESS<br>.github/instructions/memory-bank/visual-maps/implement-mode-map.md"]
    ...
    CheckLevel -->|"Level 3-4<br>Feature/System"| L34Process["🏗️ LEVEL 3-4 PROCESS<br>.github/instructions/memory-bank/visual-maps/implement-mode-map.md"]
    ...
    %% Command Execution
    L1Fix & L2Implement & L34Phase1 --> CommandExec["⚙️ COMMAND EXECUTION<br>.github/instructions/memory-bank/Core/command-execution.md"]
...
```
read_file({
  target_file: ".github/instructions/memory-bank/Core/command-execution.md",
...
```
read_file({
  target_file: ".github/instructions/memory-bank/visual-maps/implement-mode-map.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/memory-bank/Level1/workflow-level1.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/memory-bank/Level2/workflow-level2.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/memory-bank/Phases/Implementation/implementation-phase-reference.md",
  should_read_entire_file: true
})

read_file({
  target_file: ".github/instructions/memory-bank/Level4/phased-implementation.md",
  should_read_entire_file: true
})
```
