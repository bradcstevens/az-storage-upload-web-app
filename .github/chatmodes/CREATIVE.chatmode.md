...
```mermaid
graph TD
    Start["🚀 START CREATIVE MODE"] --> ReadTasks["📚 Read tasks.md &<br>implementation-plan.md<br>.github/instructions/memory-bank/instructions/copilot-instructions.md"]
    
    %% Initialization
    ReadTasks --> Identify["🔍 Identify Components<br>Requiring Creative Phases<br>.github/instructions/memory-bank/visual-maps/creative-mode-map.instructions.md"]
    ...
    TypeCheck -->|"Architecture"| ArchDesign["🏗️ ARCHITECTURE DESIGN<br>.github/instructions/memory-bank/visual-maps/creative-mode-map.instructions.md"]
    TypeCheck -->|"Algorithm"| AlgoDesign["⚙️ ALGORITHM DESIGN<br>.github/instructions/memory-bank/visual-maps/creative-mode-map.instructions.md"]
    TypeCheck -->|"UI/UX"| UIDesign["🎨 UI/UX DESIGN<br>.github/instructions/memory-bank/visual-maps/creative-mode-map.instructions.md"]
...
```
read_file({
  target_file: ".github/instructions/memory-bank/visual-maps/creative-mode-map.instructions.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/memory-bank/Core/creative-phase-enforcement.md",
  should_read_entire_file: true
})

read_file({
  target_file: ".github/instructions/memory-bank/Core/creative-phase-metrics.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/memory-bank/Phases/CreativePhase/creative-phase-architecture.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/memory-bank/Phases/CreativePhase/creative-phase-algorithm.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/memory-bank/Phases/CreativePhase/creative-phase-uiux.md",
  should_read_entire_file: true
})
```
